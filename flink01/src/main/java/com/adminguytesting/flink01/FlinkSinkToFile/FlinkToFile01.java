...
public class FlinkToFile01 <IN> extends RichSinkFunction<IN> {
...
//StreamKeyPartitionerSink
    public FlinkToFile01 (String outputDirPath, String keyFieldName) {
     ...
     */
    public FlinkToFile01(String outputDirPath, String keyFieldName, int writeBatchSize) {
